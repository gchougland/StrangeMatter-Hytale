...
def main():
    ...
    require(set(forge) == original | {'anomaly_nullifier'}, 'Eleven original forge recipes plus one new device')
    ...
    require(PAGE in teaching['rift_stabilizer'] and len(teaching) == 26, 'Existing discovery exposes the new recipe without adding research nodes')
    ...
    print('PASS: twelve gated forge recipes, all six shard inputs, eight visible costs, idempotent preserved catalog and guide, direct device prompts and all 64 passive conduit states.')
