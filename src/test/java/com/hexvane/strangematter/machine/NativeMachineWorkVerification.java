    ...
    public static void verify(World world,MachineService machines){
        ...
        try{
            ...
            for(String id:List.of("SM_Resonance_Condenser","SM_Resonant_Burner","SM_Reality_Forge","SM_Rift_Stabilizer")){
                var type=BlockType.getAssetMap().getAsset(id);var chunk=world.getChunkIfInMemory(com.hypixel.hytale.math.util.ChunkUtil.indexChunkFromBlock(x,3));
                chunk.setBlock(x,70,3,BlockType.getAssetMap().getIndex(id),type,1,0,0);
                ...
                int filler=chunk.getFiller(x,71,3);
                ...
                require(chunk.getRotationIndex(x,70,3)==1&&chunk.getFiller(x,71,3)==filler,"State transition preserves orientation and upper filler offset: "+id);
